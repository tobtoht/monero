 ...
 */
extern void Twofish_prepare_key( const Twofish_Byte key[], int key_len, Twofish_key * xkey );
 ...
 */
extern void Twofish_encrypt_block(const Twofish_key * xkey, Twofish_Byte p[16], Twofish_Byte c[16]);
 ...
 */
extern void Twofish_decrypt_block(const Twofish_key * xkey, Twofish_Byte c[16], Twofish_Byte p[16]);
