...
if(Protobuf_FOUND AND USE_DEVICE_TREZOR)
    ...
    set(_proto_messages_dir "${CMAKE_SOURCE_DIR}/src/device_trezor/trezor/messages")
    execute_process(COMMAND ${Protobuf_PROTOC_EXECUTABLE} --cpp_out "${_proto_messages_dir}" "-I${_proto_include_dir}" ${_proto_files_absolute} RESULT_VARIABLE RET OUTPUT_VARIABLE OUT ERROR_VARIABLE ERR)
    if(RET)
        trezor_fatal_msg("Trezor: protobuf messages could not be (re)generated (err=${RET}). OUT: ${OUT}, ERR: ${ERR}.")
    endif()

    # minor is a macro on FreeBSD, undefine to avoid conflict
    execute_process(COMMAND sed -i "/@@protoc_insertion_point(includes)/a\\
#ifdef minor\\
#undef minor\\
#endif" "${_proto_messages_dir}/messages-monero.pb.h")
